 ...
 * @author Pixels
 */
public class PanelUsuarioNoDisponibles extends javax.swing.JPanel {
    ControladorVistaUsuarioVenta controlador;
    Usuario usuario;

    /**
     * Creates new form panelUsuarioNoDisponibles
     * @param usuario
     */
    public PanelUsuarioNoDisponibles(Usuario usuario) {
        initComponents();
        controlador = new ControladorVistaUsuarioVenta();
        this.usuario = usuario;
        lblProductosNoDisponibles.setText(Integer.toString(controlador.obtenerProductosNoDisponiblesUsuario(usuario.getUser())));
        mostrarTabla();
    }
    ...
    private void initComponents() {
        ...
        lblProductosNoDisponibles.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        lblProductosNoDisponibles.setText("0");
        panelAbsoluto.add(lblProductosNoDisponibles, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, 50, -1));
    ...
    private void mostrarTabla(){
        tableProductos.setModel(new javax.swing.table.DefaultTableModel(
            controlador.construirMatrisProductosNoDisponiblesUsuario(usuario),
            new String [] {
                "Id", "Nombre", "Descripcion", "Precio", "Stock"
            }
        ) {
